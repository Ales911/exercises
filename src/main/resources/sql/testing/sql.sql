...
-- UPDATE testing.attempt SET result =
--     (select ROUND(AVG(is_correct)*100) from testing.answer 
--         JOIN testing.testing ON testing.answer_id = answer.answer_id AND testing.attempt_id = 8)
-- WHERE attempt_id = 8;

-- DELETE FROM testing.attempt where date_attempt < '2020-05-01';