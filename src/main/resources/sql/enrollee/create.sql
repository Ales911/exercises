...
DROP TABLE IF EXISTS enrollee.department CASCADE;
DROP TABLE IF EXISTS enrollee.subject CASCADE;
DROP TABLE IF EXISTS enrollee.program CASCADE;
DROP TABLE IF EXISTS enrollee.enrollee CASCADE;
DROP TABLE IF EXISTS enrollee.achievement CASCADE;
