...
-- SELECT name_program FROM enrollee.program
--     JOIN enrollee.program_subject 0USING(program_id)
...
-- FROM enrollee.program_enrollee JOIN enrollee.program_subject USING (program_id)
--                       JOIN enrollee.enrollee_subject USING (subject_id, enrollee_id)
-- GROUP BY  2, 1
-- ORDER BY 1, 3 DESC --)
